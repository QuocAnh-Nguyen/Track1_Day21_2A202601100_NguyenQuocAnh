...
| 4 | P3 — Viết rubric v1 | AI gợi ý danh sách tiêu chí (groundedness, citation, schema, scope, followup quality...) | Nhóm chấm chéo 25 câu (Anh + Linh) → 68% agreement → siết rubric theo bất đồng |
...
- **Chấm nhãn người** (labels-anh.csv, labels-linh.csv) — Anh và Linh chấm độc lập,
